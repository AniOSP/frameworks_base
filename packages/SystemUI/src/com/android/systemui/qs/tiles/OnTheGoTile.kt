...
import com.android.internal.util.aniosp.OnTheGoUtils
import com.android.systemui.R
import com.android.systemui.dagger.qualifiers.Background
import com.android.systemui.dagger.qualifiers.Main
import com.android.systemui.aniosp.onthego.OnTheGoService
...
class OnTheGoTile @Inject constructor(
    ...
    protected fun toggleService(enabled: Boolean) {
        val onthegoComponent = ComponentName(
            ...
            "com.android.systemui.aniosp.onthego.OnTheGoService"
        )
    ...
    override fun getMetricsCategory(): Int {
        return MetricsEvent.ANIOSP_QS_TILES
    }
